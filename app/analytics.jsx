    ...
    <>
      <div className="grid grid-cols-3 mb-24">
        <div className="card card-pad">
          <div className="kpi__label">Active subscription</div>
          <div className="kpi__val" style={{ fontSize: 22, marginTop: 6 }}>Aiingo Dashboard · Pro</div>
          <div className="muted text-xs mt-4">₹15,000/mo · renews 1 Jun 2026</div>
          <div className="row gap-6 mt-12">
            <button className="btn btn--sm">Manage</button>
            <button className="btn btn--sm btn--ghost btn--danger">Cancel</button>
          </div>
        </div>
        <div className="card card-pad">
          <div className="kpi__label">Aiingo retainer</div>
          <div className="kpi__val">₹45k<span style={{ fontSize: 14, color: 'var(--muted)', marginLeft: 4 }}>/mo</span></div>
          <div className="muted text-xs mt-4">Next invoice: 15 May 2026</div>
        </div>
        <div className="card card-pad">
          <div className="kpi__label">Year to date</div>
          <div className="kpi__val">₹2.4L</div>
          <div className="kpi__sub kpi__delta--up">↑ on track</div>
        </div>
      </div>
        ...
        <div className="card">
          ...
          <div style={{ padding: 18 }}>
            <div className="grid grid-cols-3 mb-16" style={{ gap: 8 }}>
              {[
                ...
                <button key={q.label} className="card card-pad" style={{ textAlign: 'left', cursor: 'pointer' }}
                  onClick={() => push(`Paying ${q.label}…`, { icon: 'card' })}>
            ...
            <div className="text-xs muted mt-12 row gap-6" style={{ justifyContent: 'center' }}>
              ...
              <b style={{ color: 'var(--ink)' }}>Stripe</b>
              <span>·</span>
...
function Settings({ push, onRefresh }) {
        ...
        <div>
          {tab === 'integrations' && (
            <div className="col-flex gap-16">
              ...
              <N8nEndpointsCard push={push} onRefresh={onRefresh} />
            </div>
          )}
